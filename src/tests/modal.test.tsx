...
describe('Modal Component', () => {
    ...
    it('modal renders', () => {
        ...
        render(<Modal isOpen={true} close={mockClose}>{text}</Modal>);
    ...
    describe('accessibility features', async () => {
        it('modal close on outside click', async () => {
            const user = userEvent.setup();
            render(<Modal isOpen={true} close={mockClose}><div role="heading">Modal Content</div></Modal>);
        ...
        it('modal close on ESC', async () => {
            const user = userEvent.setup();
            render(<Modal isOpen={true} close={mockClose}><div>Modal Content</div></Modal>);
